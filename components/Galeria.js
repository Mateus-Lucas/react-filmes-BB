...
const Galeria = (props) => {
    ...
    return (
        <>
            {
                props.titulo &&
                <h2 className='mt-4 text-white bg-danger text-center'>{props.titulo}</h2>
            }
            <Row>
